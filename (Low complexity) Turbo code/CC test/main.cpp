/* This is a CC simulation which can comupute the probability of correctness of a packet given the final metric under a SNR
 * Date : 2007/3/9
 */
...
#define k 300                       //frame length

#define start 5                     //starting SNR value
#define end start                     //ending SNR value

#define ERROR 3000                   //number of accumulated packet errors 
#define step 0.2                     //spacing of SNR values

#define X 100//correlation sum ~ X*10
...
int main(){
    ...
    for (j=0;j<X;j++){
        ...
        printf("%4.1f%%\n",Pc[j]*100);
        //fprintf(fp_output,"%4d ~ %4d   ",j*10,j*10+9);
        fprintf(fp_output,"%f,\n",Pc[j]);
    }  
