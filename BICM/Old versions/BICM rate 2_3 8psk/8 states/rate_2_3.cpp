/* terminated,SDD,rate 2/3 state=8 */
#define repetition 1000
#define iteration 1
#define k 1996                          //length of input bit sequence

#define lower 4//SNR                     //lower bound of SNR sampling value
#define upper 13.5//SNR                     //upper bound of SNR sampling value
