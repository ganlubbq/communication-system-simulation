...
void viterbi(float *,float *,float *,float *,float *,float *);                              //sub function,calculate the weights and optimal path
...
void output(int *v,float snr,int *r_d){
   ...
   /*-----------------decoding--------------------*/ 
    ...
    viterbi(metric1_0,metric1_1,metric2_0,metric2_1,metric3_0,metric3_1);
...
void viterbi(float *metric1_0,float *metric1_1,float *metric2_0,float *metric2_1,float *metric3_0,float *metric3_1){
