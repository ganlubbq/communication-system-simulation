...
{
   static int N_DIST = 8;
   static int STEP = 4;//NUM_RB/N_DIST;
   static int count = 0;
   ...
   // RE for RPDCCH.
   else if ((OFDMSymIdx>NUM_PDCCH_SYM) && (OFDMSymIdx!=(N_SYM-1)) && 
   (iRB==0 || iRB==25 || iRB==49))
//   (iRB==0 || iRB==5 || iRB==10 || iRB==15 || iRB==20 || iRB==25 || iRB==30 || iRB==35 || iRB==40 || iRB==45 || iRB==49))
   { return RPDCCH; }
