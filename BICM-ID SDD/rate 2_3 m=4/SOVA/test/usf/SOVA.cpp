...
//#define mul 0.2//optimal 0.2, 0.4 for improved
#define R 4
#define depth 30
#define iteration 6
#define k 4000                          //length of input bit sequence

#define lower 10//SNR                     //lower bound of SNR sampling value
#define upper 12.5//SNR                     //upper bound of SNR sampling va6ue
