...
*/
   static int recordAllocated = 0;
   if (recordAllocated == 0) { record = new int [k];recordAllocated=1; }
...
{
   static double (*pI_sym)[4][2] = new double [k+m][4][2];
   static double (*A)[st_num] = new double [k+m+1][st_num]; 
   static double (*B)[st_num] = new double [k+m+1][st_num]; 
