...
class LAB524Rand
{
 public: 
  ...
  // 
  inline double getRayleigh(double P = 1.0)
  {
    double gaussian1 = getRealGaussian(),
           gaussian2 = getRealGaussian();
           
    double rayleigh = sqrt((gaussian1*gaussian1 + gaussian2*gaussian2)*P/2.0);
